...
LATEST_TAG=carreratrack/carreratrack:latest
LOCAL_DOCKER_TAG=carreratrack/carreratrack:$(VERSION)
REMOTE_DOCKER_TAG=docker.pkg.github.com/cerhard/$(LOCAL_DOCKER_TAG)
REMOTE_LATEST_TAG=docker.pkg.github.com/cerhard/$(LATEST_TAG)
